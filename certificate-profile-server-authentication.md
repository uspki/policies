...
| Transparency Information  | Mandatory | False | Must include two or more SCTs or inclusion proofs. <br> From RFC 6962 (1.3.101.75) contains one or more. <br> "TransItem" structures in a "TransItemList" |

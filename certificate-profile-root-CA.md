...
| Issuer Distinguished Name   |       |       |  Unique X.500 Issuing CA DN as specified in Section 7.1.4 of this CP <br> (cn=US Federal Government Device Root CAx, o=U.S. Government, c=US) where x is required, starts at 1, and will be incremented if / when this CA performs a rekey |
...
| Key Usage   | Mandatory | True | c=yes; keyCertSign, crlSign   |
